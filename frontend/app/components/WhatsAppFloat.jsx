        ...
        <div className="slide-up fixed bottom-24 right-4 sm:right-6 w-[calc(100vw-2rem)] sm:w-96 bg-white rounded-2xl shadow-2xl z-[9999] overflow-hidden border-2 border-slate-200">
          ...
          >
            <div
              ...
              style={{
                backgroundImage:
                  'url("data:image/svg+xml,%3Csvg width=%2240%22 height=%2240%22 viewBox=%220 0 40 40%22 xmlns=%22http://www.w3.org/2000/svg%22%3E%3Cg fill=%22%23ffffff%22 fill-opacity=%221%22%3E%3Cpath d=%22M0 0h20v20H0V0zm10 17a7 7 0 1 0 0-14 7 7 0 0 0 0 14zm20 0a7 7 0 1 0 0-14 7 7 0 0 0 0 14zM10 37a7 7 0 1 0 0-14 7 7 0 0 0 0 14zm10-17h20v20H20V20zm10 17a7 7 0 1 0 0-14 7 7 0 0 0 0 14z%22/%3E%3C/g%3E%3C/svg%3E")',
              }}
            />
          ...
          <div className="p-5 bg-gradient-to-b from-slate-50 to-white space-y-3">
            ...
            <div className="flex flex-wrap gap-2 pl-10">
              <button
                ...
                style={{ borderColor: '#0086C0', color: '#0086C0', backgroundColor: 'white' }}
              >
                🏔️ Tours Cusco
              </button>
              <button
            ...
            <div className="pt-2">
              ...
              />
              <p className="font-tequilla text-xs text-slate-400 mt-1.5">Te responderemos en WhatsApp en menos de 5 minutos</p>
            </div>
          </div>
          ...
          <div className="p-5 bg-white border-t-2 border-slate-100">
            ...
            {/* ✅ Small alignment note under button */}
            <p className="mt-3 text-center text-xs text-slate-500 font-tequilla">
              Contacto oficial: <span className="font-bold">{WHATSAPP_PHONE}</span>
            </p>
          </div>
        </div>
      )}
