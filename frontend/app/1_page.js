...
<section
  ...
  style={{
    backgroundImage:
      "url('https://images.unsplash.com/photo-1526778548025-fa2f459cd5c1?q=80&w=2000')", // ⛰️ scenic Peru background (replace if you want)
...
>
  ...
  <div className="relative container-default text-center z-10">
    {/* Section Heading */}
    ...
    {/* Benefits Grid */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {[
              ...
              <div
                key={i}
                className="bg-white/10 border border-white/20 rounded-2xl px-6 py-8 shadow-md hover:bg-white/15 transition-all duration-300 hover:-translate-y-1"
              >
